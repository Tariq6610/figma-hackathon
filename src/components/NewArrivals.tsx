...
const NewArrivals = () => {
  return (
    <>
    <div className=' max-w-[1440px] 2xl:px-[100px] mx-auto flex flex-col items-center gap-[55px] xl:px-[50px] px-[30px] mt-[72px]'>
        <h1 className='font-bold md:text-[48px] text-[36px] tracking-tight'>NEW ARRIVALS</h1>
